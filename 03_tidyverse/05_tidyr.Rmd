...
1. Column headers are values of the key variable<br>
...
**Key-Value pairs** (KVP) - also *key-measurements*, *attribute-value*, *field-value*, *name-value*:
...
- `score` is a **measurement (value) variable**
...
- Messy (3): `dplyr` - some combination of the functions discussed previously to split the table in order to avoid redundant information
