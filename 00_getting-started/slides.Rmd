...
* Wangqian (Will) Ju
    + not a professor for sure
    + not a doctor yet
* 5th-year PhD student advised by Dr. Heike Hofmann
* R packages development
    + cmpsR
    + ggpaintr
* industrial work experience
    + Machine learning engineer/Data scientist intern at Adobe
...
- during class time on every other Thursday (starting with Thursday, Sep 14th) 
...
- tentatively scheduled for Oct 26.
...
* [slack invite link](https://join.slack.com/t/ds202fall2023/shared_invite/zt-21fue3puf-XV~37aCQLJVx1E7Cp_GsLQ)
* "messaging app for business that connects people to the information they need"
* fancy features

<img src="data/course_slack_qr.png" width=250>
...
* sign up for github using your iastate.edu email if you haven't 
