...
- maps are just data: `long`, `lat`, and `group`

- ggplot maps follow the same structure:
  points → paths → polygons

- choropleth maps = map data + joined dataset

- always check joins before mapping: `anti_join()`