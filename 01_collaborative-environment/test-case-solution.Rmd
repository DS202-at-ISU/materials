...
4.  the solution is disseminated from an R Markdown document, located at [a github repo](https://github.com/Stat585-at-ISU/materials-2019/tree/master/01_collaborative-environment).
5.  code and text/documentation are interwoven: reproducible and self-documenting.
6.  extend or refine analyses by copying and modifying code blocks.
7.  disseminate your work by sharing the RMarkdown file
8.  ghjchjgdhgj

dfsghghjdsfhjgdsfjkhdsfhjkjkhdsfjkhsfhj
